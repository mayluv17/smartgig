...
<textarea id="tt" class="form-control" placeholder="I will do real good stuff to your music" rows="2" maxlength="80" style="*text-indent: 20px; font-size: 40px; max-width: 80%;"></textarea>
...
<tr><td class="active">Price</td><td>$ &nbsp;<input type="text" placeholder="0" class="" style="display:inline; width: 50px; padding-right: 0; border: none;" /></td></tr>
...
<div class="col-md-9">
<label style="color:#A6A6A6; display: block; ">www.youtube.com/ </label>
...
<ul class="vidlink-list">
<li>http://www.youtube.com/Zs1SS <span class=""></span></li>
<li>http://www.youtube.com/Zs1SS <span class=""></span></li>
<li>http://www.youtube.com/Zs1SS <span class=""></span></li>
</ul>
